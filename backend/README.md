...
## Project Structure
    ...
    ├── raspberry_pi_contro_32492  # Django project configurations
...
1. Clone this repo and `cd raspberry_pi_contro_32492`
...
2. Clone this repo and `cd raspberry_pi_contro_32492`
